...
let renterContractAddress = "0x30CE2a598590430A16b6993112C9924B39cC3042";
...
export const register = async (name, surname) => {
  ...
  try {
    let res = await renterContract.methods.addUser(name, surname).send({ from: selectedAccount });
    return res;
  } catch (e) {
    console.error(e);
  }
...
export const addCar = async (name, url, rentFee, saleFee) => {
  ...
  try {
    let res = await renterContract.methods.addCar(name, url, rentFee, saleFee).send({ from: selectedAccount });
    return res;
  } catch (e) {
    console.error(e);
  }
...
export const editCarMetadata = async (id, name, imgUrl, rentFee, saleFee) => {
  ...
  try {
    let res = await renterContract.methods.editCarMetadata(id, name, imgUrl, rentFee, saleFee).send({ from: selectedAccount });
    return res;
  } catch (e) {
    console.error(e);
  }
...
export const editCarStatus = async (id, status) => {
  ...
  try {
    let res = await renterContract.methods.editCarStatus(id, status).send({ from: selectedAccount });
    return res;
  } catch (e) {
    console.error(e);
  }
